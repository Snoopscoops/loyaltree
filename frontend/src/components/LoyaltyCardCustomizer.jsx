          ...
          {guidedStep === 3 && (
            <>
              ...
              {form.card_type==='vip' && <>
                ...
                <div style={{marginTop:20}}>
                  <label style={styles.label}>Tier rewards</label>
                  <p style={{...styles.hint,margin:'0 0 12px'}}>Set what customers unlock when they reach each tier.</p>
