...
const BILLING_TERMS = {
  monthly: { label: 'Monthly', unit: '/30 days', multiplier: 1 },
  '3_months': { label: '3 Months', unit: '/3 months', multiplier: 3 },
  '6_months': { label: '6 Months', unit: '/6 months', multiplier: 6 },
