...
const PAGE_CONTENT = {
  overview: {
    ...
    steps: [
      ...
      ['3', 'Staff records real activity', 'Authorized cashiers scan the customer card and record stamps, points, visits, subscription activity or other loyalty actions.'],
      ['4', 'The customer sees progress', 'The same Wallet card reflects rewards, loyalty progress, subscription status, loyalty tiers or remaining sessions.'],
    ...
    features: [
      ...
      ['🎁', 'Flexible loyalty programs', 'Run stamps, points, subscriptions, multi-pass programs, loyalty tiers and other supported loyalty experiences.'],
...
function PublicInfoPage({ type='overview', API_BASE='' }) {
  ...
  const overviewSteps = [
    ...
    {number:'04', icon:'🎁', title:'Reward Progress Updates', body:'Stamps, points, tiers, subscriptions or sessions update in the customer record.'},
