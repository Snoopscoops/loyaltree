...
function HomePage({ onNavigateLogin, API_BASE = '' }) {
  ...
  const applyBusiness = (placement = 'homepage') => {
    trackEvent(API_BASE, 'apply_business_click', {
      page_name: 'Homepage',
      metadata: { placement, pricing_region: pricingContext.country_code, currency: pricingContext.currency },
    })
    navigate(`/signup?country=${encodeURIComponent(pricingContext.country_code || 'PH')}`)
  }

  const homeMonthlyPrice = (planKey, fallback) =>
    Number(pricingContext?.plans?.[planKey]?.price_month ?? fallback)
      ...
      <section id="pricing" className="lt-pricing-section" style={styles.homePricingSection}>
        ...
        <div style={styles.homePricingCards}>
          <div style={styles.homePriceCard}>
            ...
            <div style={styles.homePrice}>{formatMoney(homeMonthlyPrice('starter',350), pricingContext.currency)}<span style={styles.homePriceUnit}>/mo</span></div>
          ...
          <div style={{...styles.homePriceCard,...styles.homePriceCardFeatured}}>
            ...
            <div style={styles.homePrice}>{formatMoney(homeMonthlyPrice('growth',550), pricingContext.currency)}<span style={styles.homePriceUnit}>/mo</span></div>
          ...
          <div style={styles.homePriceCard}>
            ...
            <div style={styles.homePrice}>{formatMoney(homeMonthlyPrice('pro',750), pricingContext.currency)}<span style={styles.homePriceUnit}>/mo</span></div>
