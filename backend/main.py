...
SHOWROOM_CSS = """
:root{--gold:#c99518;--gold-dark:#9f7410;--ink:#111214;--muted:#666b73;--line:#e8e8e8;--soft:#f7f7f6;--white:#fff;--shadow:0 18px 50px rgba(17,18,20,.08)}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:#fff;color:var(--ink);font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;overflow-x:hidden}button,input{font:inherit}button,a{-webkit-tap-highlight-color:transparent}button{cursor:pointer}img{max-width:100%}
.site-nav{position:sticky;top:0;z-index:80;background:rgba(255,255,255,.94);backdrop-filter:blur(14px);border-bottom:1px solid rgba(232,232,232,.9)}.site-nav-inner{max-width:1240px;margin:auto;padding:12px 24px;display:flex;align-items:center;gap:28px}.site-brand{display:flex;align-items:center;gap:12px;text-decoration:none;color:var(--ink);min-width:max-content}.site-brand-mark{width:58px;height:58px;display:grid;place-items:center}.site-brand-mark img{width:100%;height:100%;object-fit:contain}.site-brand-name{font-weight:800;letter-spacing:.09em;font-size:17px;text-transform:uppercase}.site-nav-links{margin-left:auto;display:flex;align-items:center;gap:28px}.site-nav-links a{color:#232323;text-decoration:none;font-size:13px;font-weight:700}.site-nav-links a:hover{color:var(--gold-dark)}.site-nav-cta{border:1px solid var(--gold)!important;border-radius:10px;padding:10px 15px}
.hero{position:relative;max-width:1240px;margin:auto;padding:52px 24px 32px;background:#fff}.hero-actions{display:none}.hero-overlay{display:grid;grid-template-columns:minmax(0,.9fr) minmax(500px,1.1fr);gap:30px;align-items:center}.hero-copy{padding:22px 0}.hero-eyebrow,.home-kicker{display:inline-flex;align-items:center;gap:8px;text-transform:uppercase;letter-spacing:.08em;font-size:11px;font-weight:800;color:#805f10;background:#fbf5e6;border:1px solid #ead8a6;border-radius:999px;padding:7px 11px}.hero-eyebrow .dot{width:6px;height:6px;border-radius:50%;background:var(--gold)}.hero-logo{display:none}.hero h1{font-size:clamp(46px,5.5vw,76px);line-height:.98;letter-spacing:-.055em;margin:18px 0 20px;max-width:670px}.hero-subtitle{font-size:16px;line-height:1.7;color:var(--muted);max-width:590px;margin:0}.hero-cta-row{display:flex;gap:14px;margin-top:28px}.hero-primary-btn,.hero-secondary-btn,.agent-modal-submit,.connect-apply-link,.location-directions-btn{min-height:48px;border-radius:9px;padding:0 20px;font-weight:800;border:1px solid var(--gold);display:inline-flex;align-items:center;justify-content:center;text-decoration:none}.hero-primary-btn,.agent-modal-submit{background:var(--gold);color:#111}.hero-primary-btn:hover,.agent-modal-submit:hover{background:var(--gold-dark);color:#fff}.hero-secondary-btn{background:#fff;color:#171717}.hero-secondary-btn:hover{background:#faf7ef}.hero-assurance-list,.hero-metrics{display:none}.hero-visual{min-height:465px;position:relative;display:flex;align-items:center;justify-content:center}.hero-visual:before{content:"";position:absolute;inset:10% 3% 4% 5%;background:radial-gradient(circle at center,rgba(201,149,24,.12),transparent 63%);filter:blur(2px)}.hero-car-stage{position:relative;width:100%;height:100%;min-height:450px;display:flex;align-items:center;justify-content:center}.hero-car-stage:after{content:"";position:absolute;left:10%;right:8%;bottom:9%;height:45px;background:rgba(0,0,0,.18);filter:blur(23px);border-radius:50%}.hero-car-image{position:relative;z-index:2;width:100%;max-height:455px;object-fit:contain;filter:drop-shadow(0 24px 24px rgba(0,0,0,.13))}.hero-car-fallback{position:relative;z-index:2;width:86%;height:320px;border-radius:28px;background:linear-gradient(145deg,#f8f8f8,#fff);border:1px solid var(--line);display:grid;place-items:center;font-size:92px;box-shadow:var(--shadow)}.hero-plate-logo{width:22px;height:22px;display:inline-flex}.hero-plate-logo img{width:100%;height:100%;object-fit:contain}.hero-plate{position:absolute;z-index:3;display:flex;align-items:center;gap:6px;bottom:19%;left:50%;transform:translateX(-50%);background:#0d0d0d;border:2px solid var(--gold);color:#fff;border-radius:5px;padding:6px 13px;font-size:12px;font-weight:800;letter-spacing:.08em;box-shadow:0 4px 12px rgba(0,0,0,.25)}
.trust-strip{max-width:1240px;margin:0 auto;padding:0 24px 34px}.trust-grid{display:grid;grid-template-columns:repeat(4,1fr);border:1px solid var(--line);border-radius:14px;overflow:hidden;background:#fff}.trust-item{padding:24px 22px;display:grid;grid-template-columns:42px 1fr;column-gap:13px;align-items:start;border-right:1px solid var(--line)}.trust-item:last-child{border-right:0}.trust-icon{grid-row:1/3;width:40px;height:40px;border:1px solid #e7c767;border-radius:50%;display:grid;place-items:center;color:var(--gold-dark);font-size:19px;font-weight:900}.trust-title{font-size:14px;font-weight:800;line-height:1.3}.trust-text{font-size:12px;line-height:1.5;color:var(--muted);margin-top:5px}
.home-section,.inventory-shell,.connect-section,.location-wrap{max-width:1240px;margin:0 auto;padding:56px 24px}.home-section{display:none}.inventory-shell{padding-top:24px}.inventory-toolbar{margin-bottom:16px}.stats-strip{display:flex;align-items:end;justify-content:space-between;gap:20px;margin-bottom:16px}.stats-strip h2{font-size:30px;letter-spacing:-.03em;margin:0}.stats-strip span{font-size:13px;color:var(--muted)}.search-wrap{display:inline-block;width:min(390px,100%);vertical-align:middle;margin-right:10px}.search-input{width:100%;height:44px;border:1px solid var(--line);border-radius:9px;padding:0 15px;background:#fff;outline:none}.search-input:focus{border-color:var(--gold);box-shadow:0 0 0 3px rgba(201,149,24,.12)}.filter-bar{display:inline-flex;gap:8px;vertical-align:middle;flex-wrap:wrap}.make-filter-bar{display:flex;margin-top:10px}.filter-chip{height:42px;padding:0 14px;border:1px solid var(--line);border-radius:9px;background:#fff;color:#333;font-size:12px;font-weight:700}.filter-chip.active{border-color:var(--gold);background:#fbf5e6;color:#6f5108}.chip-count{opacity:.7}
.car-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px}.car-card{border:1px solid var(--line);border-radius:12px;background:#fff;overflow:hidden;transition:.22s ease;cursor:pointer}.car-card:hover{transform:translateY(-4px);box-shadow:var(--shadow);border-color:#dfd3b5}.car-gallery{position:relative;height:230px;background:#f3f3f2;overflow:hidden}.gal-track{display:flex;height:100%;transition:transform .3s ease}.gal-track img{width:100%;min-width:100%;height:100%;object-fit:cover}.no-image{height:230px;background:#f3f3f2;display:grid;place-items:center;font-size:58px}.badge{position:absolute;z-index:5;top:10px;left:10px;border-radius:5px;padding:5px 8px;font-size:10px;text-transform:uppercase;font-weight:900;letter-spacing:.06em;background:#151515;color:#fff}.badge.reserved{background:#a14b2c}.gal-btn{position:absolute;z-index:5;top:50%;transform:translateY(-50%);width:34px;height:34px;border-radius:50%;border:0;background:rgba(255,255,255,.92)}.gal-btn.prev{left:10px}.gal-btn.next{right:10px}.gal-dots{position:absolute;z-index:4;bottom:10px;left:50%;transform:translateX(-50%);display:flex;gap:5px}.gal-dots .dot{width:6px;height:6px;border-radius:50%;background:rgba(255,255,255,.55)}.gal-dots .dot.active{background:#fff}.gal-count{position:absolute;right:10px;bottom:8px;background:rgba(0,0,0,.6);color:#fff;font-size:10px;padding:4px 7px;border-radius:999px}.car-info{padding:16px}.car-info h3{font-size:17px;margin:0 0 10px;letter-spacing:-.02em}.car-meta{font-size:12px;color:var(--muted);margin:0 0 15px}.car-price-row{display:flex;justify-content:space-between;align-items:flex-end;border-top:1px solid #f0f0f0;padding-top:13px}.car-price{font-size:20px;font-weight:900;color:var(--gold-dark)}.car-price-note{font-size:10px;color:var(--muted);display:block;margin-top:2px}.empty-state{text-align:center;padding:65px 20px;border:1px dashed var(--line);border-radius:14px;color:var(--muted)}.empty-state .icon{font-size:50px}
.process-section{display:block;background:#fafafa;border-radius:22px;margin-top:28px}.process-section .home-heading,.agent-cta-section .home-heading{font-size:34px;margin:14px 0}.home-copy{color:var(--muted);line-height:1.7;max-width:780px}.process-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:25px}.process-card{padding:22px;background:#fff;border:1px solid var(--line);border-radius:13px}.process-n{width:34px;height:34px;border-radius:50%;background:#f7e7bb;color:#6d4d00;display:grid;place-items:center;font-weight:900}.process-card h3{font-size:16px}.process-card p{font-size:13px;color:var(--muted);line-height:1.6}.agent-cta-section{display:flex;align-items:center;justify-content:space-between;gap:35px;border:1px solid var(--line);border-radius:18px;margin-top:28px}.agent-cta-benefits{display:flex;flex-wrap:wrap;gap:8px 18px;margin-top:18px;color:#4f4f4f;font-size:13px}.agent-cta-btn{flex:none;border:0}
.connect-section{padding-top:30px}.contact-note{background:#171717;color:#fff;border-radius:20px;padding:38px;text-align:center}.connect-title{font-size:30px;font-weight:900}.connect-fb-btn{display:inline-flex;margin-top:18px;padding:13px 18px;border-radius:9px;background:var(--gold);color:#111;text-decoration:none;font-weight:800}.connect-phones{margin-top:15px;color:#ccc}.connect-phones a{color:#fff}.connect-apply-row{display:flex;justify-content:center;gap:10px;margin-top:20px}.connect-apply-link{background:transparent;color:#fff;border-color:#8a8a8a}.location-wrap{padding-top:18px}.location-title{font-size:28px;font-weight:900}.location-address{color:var(--muted);margin:8px 0 16px}.location-map{height:330px;border-radius:16px;overflow:hidden;border:1px solid var(--line)}.location-map iframe{width:100%;height:100%;border:0}.location-directions-btn{margin-top:14px;background:#fff;color:#111;width:max-content}.footer{text-align:center;padding:28px;color:#777;font-size:12px;border-top:1px solid var(--line)}
.lightbox,.vehicle-modal,.agent-modal{position:fixed;inset:0;background:rgba(0,0,0,.66);z-index:200;display:none;align-items:center;justify-content:center;padding:20px}.lightbox.open,.vehicle-modal.open,.agent-modal.open{display:flex}.vehicle-modal-card,.agent-modal-card{width:min(720px,100%);max-height:92vh;background:#fff;border-radius:18px;overflow:auto;position:relative;box-shadow:0 30px 90px rgba(0,0,0,.3)}.agent-modal-card{width:min(470px,100%)}.vehicle-modal-close,.agent-modal-close,.lightbox-close{position:absolute;right:12px;top:12px;z-index:8;width:38px;height:38px;border-radius:50%;border:0;background:#fff;box-shadow:0 4px 15px rgba(0,0,0,.15);font-size:22px}.vehicle-modal-gallery{height:360px;background:#eee}.vehicle-modal-gallery img{width:100%;height:100%;object-fit:cover}.vehicle-modal-body,.agent-modal-scroll{padding:25px}.vehicle-modal-title,.agent-modal-title{margin:0 0 8px;font-size:25px}.vehicle-modal-meta,.agent-modal-sub{color:var(--muted)}.vehicle-modal-price{font-size:25px;font-weight:900;color:var(--gold-dark);margin:18px 0}.vehicle-specs{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}.vehicle-spec{padding:12px;background:#f8f8f8;border-radius:9px}.vehicle-spec-label{font-size:10px;text-transform:uppercase;color:#888}.vehicle-spec-value{font-weight:700;margin-top:4px}.vehicle-inquire-btn{width:100%;min-height:50px;border:0;border-radius:9px;background:var(--gold);font-weight:900;margin-top:18px}.agent-modal-view input,.agent-modal-view select,.agent-modal-view textarea{width:100%;padding:12px 13px;margin:6px 0;border:1px solid var(--line);border-radius:9px;outline:none}.agent-modal-view input:focus,.agent-modal-view textarea:focus{border-color:var(--gold)}.agent-modal-submit{width:100%;border:0;margin-top:10px}.agent-modal-switch{text-align:center;margin-top:14px;font-size:13px}.agent-modal-error{padding:10px;background:#fff1f1;color:#a22727;border-radius:8px;margin-top:8px}.inquiry-radio-row{display:flex;gap:13px;flex-wrap:wrap}.inquiry-radio-row label,.inquiry-checkbox-row{font-size:13px}.inquiry-tradein{display:none}.sell-photos-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}.sell-photo-add{aspect-ratio:1;border:1px dashed #bbb;border-radius:9px;background:#fafafa}.sell-photo-count,.inquiry-field-label{font-size:12px;color:#777;margin-top:9px}.lightbox img{max-width:90vw;max-height:86vh}.lightbox-prev,.lightbox-next{position:absolute;top:50%;width:46px;height:46px;border:0;border-radius:50%}.lightbox-prev{left:18px}.lightbox-next{right:18px}
@media(max-width:900px){.site-nav-links a:not(.site-nav-cta){display:none}.hero-overlay{grid-template-columns:1fr}.hero{padding-top:30px}.hero-copy{text-align:center}.hero h1{margin-left:auto;margin-right:auto;font-size:52px}.hero-subtitle{margin:auto}.hero-cta-row{justify-content:center}.hero-visual{min-height:350px}.hero-car-stage{min-height:340px}.hero-car-image{max-height:340px}.trust-grid{grid-template-columns:repeat(2,1fr)}.trust-item:nth-child(2){border-right:0}.trust-item:nth-child(-n+2){border-bottom:1px solid var(--line)}.car-grid{grid-template-columns:repeat(2,1fr)}}
@media(max-width:600px){.site-nav-inner{padding:8px 14px}.site-brand-mark{width:48px;height:48px}.site-brand-name{font-size:13px}.site-nav-cta{padding:9px 11px!important;font-size:11px!important}.hero{padding:24px 16px 12px}.hero-overlay{gap:5px}.hero-copy{text-align:left;padding:10px 0}.hero-eyebrow{font-size:9px;padding:6px 9px}.hero h1{font-size:42px;line-height:1.02;margin:15px 0 14px}.hero-subtitle{font-size:14px;line-height:1.55}.hero-cta-row{display:grid;grid-template-columns:1fr;margin-top:20px}.hero-primary-btn,.hero-secondary-btn{width:100%}.hero-visual{min-height:245px}.hero-car-stage{min-height:240px}.hero-car-image{max-height:250px}.hero-plate{font-size:8px;padding:4px 8px;bottom:15%}.trust-strip{padding:8px 16px 26px}.trust-grid{grid-template-columns:repeat(2,1fr)}.trust-item{display:block;text-align:center;padding:17px 8px;min-height:145px}.trust-item:nth-child(odd){border-right:1px solid var(--line)}.trust-item:nth-child(even){border-right:0}.trust-item:nth-child(-n+2){border-bottom:1px solid var(--line)}.trust-icon{margin:0 auto 10px}.trust-title{font-size:12px}.trust-text{font-size:10px}.inventory-shell,.home-section,.connect-section,.location-wrap{padding-left:16px;padding-right:16px}.inventory-shell{padding-top:20px}.stats-strip{align-items:flex-start}.stats-strip h2{font-size:25px}.stats-strip span{font-size:11px}.search-wrap{width:100%;margin:0 0 9px}.filter-bar{display:flex;overflow-x:auto;flex-wrap:nowrap;padding-bottom:4px;width:100%;scrollbar-width:none}.filter-bar::-webkit-scrollbar{display:none}.filter-chip{flex:none}.car-grid{grid-template-columns:1fr;gap:14px}.car-gallery,.no-image{height:235px}.process-grid{grid-template-columns:1fr}.process-section{border-radius:0;margin-top:20px}.agent-cta-section{display:block}.agent-cta-btn{width:100%;margin-top:20px}.connect-apply-row{display:grid}.contact-note{padding:28px 18px}.location-map{height:250px}.vehicle-modal,.agent-modal{padding:0;align-items:flex-end}.vehicle-modal-card,.agent-modal-card{border-radius:20px 20px 0 0;max-height:94vh}.vehicle-modal-gallery{height:255px}.vehicle-specs{grid-template-columns:1fr}.sell-photos-grid{grid-template-columns:repeat(3,1fr)}}
"""
...
async def showroom_page(business_public_id: str):
    try:
        ...
        featured_vehicle_image = ''
        for _vehicle in vehicles:
            _images = _vehicle.get('image_urls') or ([_vehicle.get('image_url')] if _vehicle.get('image_url') else [])
            _images = [x for x in _images if x]
            if _images:
                featured_vehicle_image = _images[0]
                break

        logo_html = ('<img src="' + html_lib.escape(logo_url) + '" alt="Logo"/>') if logo_url else '&#128663;'
        hero_visual_html = (
            '<div class="hero-car-stage"><img class="hero-car-image" src="' + html_lib.escape(featured_vehicle_image) + '" alt="Featured vehicle">'
            '<div class="hero-plate"><span class="hero-plate-logo">' + logo_html + '</span><span>WOLF CARS</span></div></div>'
        ) if featured_vehicle_image else (
            '<div class="hero-car-stage"><div class="hero-car-fallback">&#128663;</div></div>'
        )
        hero_html = (
            '<section class="hero">'
            '<div class="hero-overlay"><div class="hero-copy">'
            '<div class="hero-eyebrow"><span class="dot"></span>Verified dealership inventory</div>'
            '<h1>Drive home<br>your next car—<br>without the<br>usual delays.</h1>'
            '<p class="hero-subtitle">Explore ready-to-deliver cash and rent-to-own vehicles, review complete details, and send your inquiry online.</p>'
            ...
            '</div></div><div class="hero-visual">' + hero_visual_html + '</div></div></section>'
        )
        ...
        if vehicles:
            ...
            '<a href="#inventory">Available Cars</a><a href="#why-us">Why Choose Us</a>'
            '<a href="#how-it-works">How It Works</a><a href="#agent-section">Become an Agent</a>'
            '<a href="#connect">Contact Us</a><button id="agent-login-btn" class="site-nav-cta" type="button">Agent Login</button>'
            '</div></div></nav>'
        )
        trust_html = (
            '<section id="why-us" class="trust-strip"><div class="trust-grid">'
        ...
        agent_cta_html = (
            '<section id="agent-section" class="home-section agent-cta-section">'
